...
const Devices = () => {
  ...
  const statusCounts = {
    ...
    online: sampleDevices.filter((d) => d.status === "Online").length,
    offline: sampleDevices.filter((d) => d.status === "Offline").length,
    maintenance: sampleDevices.filter((d) => d.status === "Maintenance").length,
  };
