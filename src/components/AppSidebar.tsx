...
import { Wind, Home, Map, Users, Car, BarChart3, MapPin, Settings, ChevronDown, User, Shield, LogOut, X } from "lucide-react";
          ...
          <DropdownMenu>
                ...
                {(!isCollapsed || isMobile) && (
                  <>
                    <div className="flex flex-col flex-1 min-w-0">
                      <span className="font-semibold text-sm text-white [&[data-mobile=true]]:text-gray-800">ADMIN</span>
                      <span className="text-xs text-white/70 [&[data-mobile=true]]:text-gray-500 truncate">admin@ekaze.com</span>
                    </div>
            ...
            <DropdownMenuContent align="end" side="top" className="w-72 p-0 rounded-lg mb-4 mx-4 bg-white border shadow-lg z-50">
              <div className="p-4 flex items-center gap-4 border-b">
                <img src="https://i.pravatar.cc/40?u=admin" alt="Admin" className="w-14 h-14 rounded-full border-2 border-gray-200" />
                <div>
